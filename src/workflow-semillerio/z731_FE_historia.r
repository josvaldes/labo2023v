...
PARAM  <- list()
PARAM$experimento <- "FE7310Semillerios"

PARAM$exp_input  <- "DR7210Semillerios"
...
PARAM$RandomForest$semilla  <- 792637    # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 848461   # cambiar por la propia semilla

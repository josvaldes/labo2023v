...
PARAM  <- list()
PARAM$experimento  <- "ZZ8910ests4"
PARAM$exp_input  <- "HT8510ests4"

PARAM$modelos  <- 2       #aumentar si se quieren mas modelos
PARAM$semilla  <- 961069  # siempre se debera probar con 5 semillas, en 5 experimentos distintos, y presentar la media y/o los graficos detallados de las cinco curvas si corresponde

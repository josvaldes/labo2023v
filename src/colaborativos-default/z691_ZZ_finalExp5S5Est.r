...
PARAM  <- list()
PARAM$experimento  <- "ZZ8910ests5"
PARAM$exp_input  <- "HT8510ests5"

PARAM$modelos  <- 2       #aumentar si se quieren mas modelos
PARAM$semilla  <- 854921  # siempre se debera probar con 5 semillas, en 5 experimentos distintos, y presentar la media y/o los graficos detallados de las cinco curvas si corresponde

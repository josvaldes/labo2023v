...
PARAM  <- list()
PARAM$experimento <- "TS6410estExp13072021"
...
PARAM$train$training     <- c( 202101, 202012, 202011, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905 )

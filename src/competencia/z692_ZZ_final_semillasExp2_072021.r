...
PARAM  <- list()
PARAM$experimento  <- "ZZ6910ml072021Exp2"
PARAM$exp_input  <- "HT6510ml072021Exp2"
...
PARAM$semillas  <- c( 792637, 848461, 904619, 961069, 854921, 100591, 100609, 100613, 100621, 100649) #reemplazar por las propias semillas

...
PARAM  <- list()
PARAM$experimento <- "TS6410estExp11.1092021(1)"
...
PARAM$final_train  <- c( 202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202002, 202001, 201912, 201911, 201910, 201909 )

PARAM$train$training     <- c( 202103, 202102, 202101, 202012, 202011, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905 )

...
PARAM  <- list()
PARAM$experimento <- "TS6410estExp11072021"

PARAM$exp_input  <- "FE7410est"

# me salteo los meses duros de pandemia, pero llego hasta 201907 en training
# entreno en 18 meses

PARAM$future       <- c( 202107 )
PARAM$final_train  <- c( 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202002, 202001, 201912, 201911, 201910, 201909 )

PARAM$train$training     <- c( 202103, 202102, 202101, 202012, 202011, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907 )
PARAM$train$validation   <- c( 202104 )
PARAM$train$testing      <- c( 202105, 202106, 202105 )
...
PARAM$train$semilla  <- 792637  # cambiar por su propia semilla  !!! 
